...
namespace modem
{
    ...
    private:
        ...
        /**
         * @brief Sets the fine-tune symbol levels.
         * @param[in] data Buffer containing symbol level frame.
         * @param length Length of buffer.
         * @returns uint8_t Reason code.
         */
         ...
         * @param[in] data Buffer containing RX level frame.
         * @param length Length of buffer.
         * @returns uint8_t Reason code.
         */
